...
import type { DirectClientMulti } from "./index.ts";
...
function validateUUIDParams(
    ...
    elizaLogger.log('validateUUIDParams', params)
...
export function createApiRouter(
    ...
    directClient: DirectClientMulti
) {
    ...
    router.get("/agents", (req, res) => {
        elizaLogger.log('router agents', agents)
        // console.log('router agents', agents)
